            ...
            {companies.length === 0 ? (
              ...
              companies.map((company) => (
                <TableRow key={company.id}>
                  ...
                  <TableCell>
                    {company.members[0]?.user.email || 'N/A'}
                  </TableCell>
                  <TableCell>
                    {company.plans?.[0]?.plan.name || (
                  ...
                  <TableCell>{company._count.workspaces}</TableCell>
                  <TableCell>{company._count.members}</TableCell>
                  <TableCell>
                    {new Date(company.createdAt).toLocaleDateString()}
                  </TableCell>
                  <TableCell className="text-right">
                    <Button variant="ghost" size="sm" asChild>
                      <Link href={`/internal/companies/${company.id}`}>View</Link>
                    </Button>
                  </TableCell>
                </TableRow>
              ))
