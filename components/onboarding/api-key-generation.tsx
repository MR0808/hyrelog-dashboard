...
export function ApiKeyGeneration({
    companyId,
    workspaces
}: ApiKeyGenerationProps) {
            ...
            <CardContent className="pt-6">
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            value={type}
                            onValueChange={(value: 'COMPANY' | 'WORKSPACE') =>
                                setType(value)
                            }
                            disabled={isPending}
                        >
                        ...
                        <p className="text-xs text-muted-foreground">
                            Company keys work across all workspaces. Workspace
                            keys are scoped to a specific workspace.
                        </p>
                    </div>
