    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        startTransition(async () => {
            try {
                ...
                if (result.success) {
                    // Onboarding step is now updated automatically in createWorkspace
                    // No need for separate updateOnboardingStep call
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Examples: Production, Staging, Development, or
                    ...
                    <div className="flex justify-between pt-4">
                        <FancyButton
                            ...
                            iconPosition="left"
                        >
                            <Link href="/onboarding/billing">Back</Link>
                        </FancyButton>
                        <FancyButton
                            type="submit"
