    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            We're excited to have you on board. HyreLog helps you maintain
            immutable audit logs with hash-chain verification, ensuring
            compliance and security for your applications.
          </Text>
