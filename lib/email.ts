...
export async function sendWelcomeEmail(
    ...
    const html = await render(WelcomeEmail(options));
    const text = await render(WelcomeEmail(options), { plainText: true });
...
export async function sendPasswordResetEmail(
    ...
    const html = await render(PasswordResetEmail(options));
    const text = await render(PasswordResetEmail(options), { plainText: true });
...
export async function sendAlertThresholdEmail(
    ...
    const html = await render(AlertThresholdEmail(options));
    const text = await render(AlertThresholdEmail(options), {
        plainText: true
    });
...
export async function sendGdprRequestEmail(
    ...
    const html = await render(GdprRequestEmail(options));
    const text = await render(GdprRequestEmail(options), { plainText: true });
