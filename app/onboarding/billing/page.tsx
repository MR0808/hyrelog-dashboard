...
export default async function OnboardingBillingPage({
  ...
  const hasSuccess = params.success === 'true' || params.success === true || params.success === '1';
  const sessionId = params.session_id || (params as any).sessionId || (params as any)['session_id'];
      ...
      <div className="flex min-h-screen items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-destructive">Payment Verification Issue</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2 justify-center">
              <FancyButton asChild variant="outline" size="md">
                <Link href="/onboarding/plan">Back to Plans</Link>
              </FancyButton>
