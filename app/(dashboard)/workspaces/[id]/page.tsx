    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{workspace._count.projects}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">{workspace.company.name}</p>
              </div>
              <div>
        ...
        <TabsContent value="api-keys" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>API keys for this workspace</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="webhooks" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Webhook endpoints for this workspace</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
        ...
        <TabsContent value="events" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest audit events for this workspace</CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
