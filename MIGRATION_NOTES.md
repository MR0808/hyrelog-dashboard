...
**⚠️ Known Issue with Prisma 7:**

-   `better-auth`'s `prismaAdapter` is **NOT fully compatible with Prisma 7** yet
-   Error: `Cannot read properties of undefined (reading 'usePlural')`
-   This occurs because better-auth accesses Prisma internals that changed in Prisma 7

**Workarounds:**

1. Wait for better-auth to release Prisma 7 support
2. Check better-auth GitHub for updates: https://github.com/better-auth/better-auth
3. Consider temporarily using Prisma 6 if authentication is critical
4. Monitor better-auth releases for Prisma 7 compatibility

**Migration Steps:**

1. Review better-auth changelog for new features
2. Test authentication flows (may fail with Prisma 7)
